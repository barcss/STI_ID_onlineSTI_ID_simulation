...
const Home = () => {
    return (<>
        <div className="w-screen h-screen items-center flex flex-row p-1 container">
            <div className=' w-1/2'>
                <p className=' font-bold text-3xl'>STI ID</p>
                <p className=''>Capture your best photo on your ID</p>
