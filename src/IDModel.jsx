    ...
    <>
      <div className="flex flex-col">
        <div className="p-2 bg-white w-screen sticky z-50 top-0 justify-end flex">
          ...
          ></div>
          <div
            className={`fixed top-0 lg:w-3/12 md:w-6/12 w-9/12 z-90 transform transition-transform h-full bg-gray-200 p-3  ${
          ...
          >
            ...
            <div className="flex flex-col gap-3 mt-3">
              ...
              <input id="img" hidden type="file" accept="img" />
              <button className={`white-blue ${ onCam ? 'invisible hidden' : 'visible block'}`} onClick={() => {
                openCamera(),
                setOnCam(true)
              }}>
                Use live camera
              </button>
              <button className={`white-blue ${ onCam ? 'visible block' : 'invisible hidden'}`} onClick={() => {
                closeCamera(),
                setOnCam(false)
              }}>
                Close live camera
            ...
            >
              ...
              <div className="bg-yellow-300 h-full relative flex flex-col items-center justify-center">
                ...
                <video
                  ...
                  autoPlay
                  playsInline
                  className={`border rounded-lg bg-white mt-5 z-10 w-8/12 h-5/12 p-0 transform scale-x-[-1] object-cover ${onCam ? 'block visible' : 'invisible hidden' }`}
                />
                
                <img src='https://miro.medium.com/v2/resize:fit:1100/format:webp/1*hXoDbQqNdbnH2zW4z9Ch5Q.jpeg' className={` rounded-lg bg-white mt-5 z-10 w-8/12 h-5/12 p-0 ${onCam ? ' invisible hidden' : 'block visible'}`}/>
